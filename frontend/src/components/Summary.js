        ...
        <>
            ...
            <form>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control mb-1" onChange={handleAddressInputChanged} id="address"/>
                </div>
                <div className="mb-3">
                    <label htmlFor="postcode" className="form-label">우편번호</label>
                    <input type="text" className="form-control" onChange={handlePostcodeInputChanged} id="postcode"/>
                </div>
